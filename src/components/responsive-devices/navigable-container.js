...
const { focus } = wp.dom;
const { UP, DOWN, LEFT, RIGHT, TAB } =  wp.keycodes;
...
class NavigableContainerControl extends Component {
	constructor() {
		super( ...arguments );
...
export class NavigableMenuControl extends Component {
	render() {
